...
function App() {
  ...
  return (
    <div className="relative min-h-svh w-full">
      ...
      <div
        aria-hidden
        className="viewport-backdrop -z-10 overflow-hidden"
        style={{
          background:
      ...
      >
        <ResponsiveImage
          ...
          className="viewport-backdrop-image"
        />
      </div>
      {/* Dims the forest in dark mode. */}
      <div
        aria-hidden
        className="viewport-backdrop pointer-events-none -z-10 bg-transparent transition-colors dark:bg-black/45"
      />
