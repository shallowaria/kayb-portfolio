...
import { Home, Briefcase, FolderGit2, Mail, type LucideIcon } from 'lucide-react'

import { cn } from '@/shared/lib/utils'
import { useContent } from '@/shared/i18n/use-content'
import { resources } from '@/shared/i18n/resources'

type Key = 'home' | 'experience' | 'projects' | 'contact'

const KEYS: Key[] = ['home', 'experience', 'projects', 'contact']
          ...
          return (
            <li key={key}>
              <a
                ...
                className="group relative flex items-center gap-1.5 py-1 text-sm font-medium tracking-wide text-foreground/80 transition-colors hover:text-foreground"
              >
                <Icon className="size-4 shrink-0" />
                {/* Invisible sizers in both languages reserve the max text width
                    so switching language never shifts the layout. */}
